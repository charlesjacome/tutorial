...
type
  ...
  public
    ...
    function pr_Registrar_GCM(id_usuario: Integer; token: string; const ARequestFilter: string = ''): Integer;
  end;

const
  TServerMethods1_pr_Registrar_GCM: array [0..2] of TDSRestParameterMetaData =
  (
...
function TServerMethods1Client.pr_Registrar_GCM(id_usuario: Integer; token: string; const ARequestFilter: string): Integer;
begin
  ...
  Result := Fpr_Registrar_GCMCommand.Parameters[2].Value.GetInt32;
end;
